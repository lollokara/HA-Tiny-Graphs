...
exports.sendNotification = exports.sendErrorNotification = exports.parseWidgetParams = exports.numberFormatterShort = exports.numberFormatterLong = exports.getDynamicGradient = exports.getDynamicColor = exports.getDeviceAppearance = exports.getDaysInMonth = void 0;
...
const numberFormatterLong = new Intl.NumberFormat('ua', {
  notation: 'compact',
  compactDisplay: 'short',
  maximumFractionDigits: 2,
  minimumFractionDigits: 0
}).format;
exports.numberFormatterLong = numberFormatterLong;
const currencyFormatter = new Intl.NumberFormat('ua', {
  notation: 'compact',
  compactDisplay: 'short',
  maximumFractionDigits: 2,
